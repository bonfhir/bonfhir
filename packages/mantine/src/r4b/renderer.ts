...
import {
  ...
  MantineFhirInputResourceSelector,
  MantineFhirInputResourceType,
...
export const MantineRenderer: FhirUIRenderer = {
  ...
  FhirInputResourceType: MantineFhirInputResourceType,
  FhirInputResourceSelector: MantineFhirInputResourceSelector,
